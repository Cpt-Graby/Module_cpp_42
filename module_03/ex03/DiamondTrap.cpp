...
/*   Updated: 2023/05/03 12:27:17 by agonelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
DiamondTrap &DiamondTrap::operator=(DiamondTrap const &src) {
  if (this != &src) {
    ...
    this->FragTrap::_energyPts = src.FragTrap::_energyPts;
...
std::ostream & operator<<(std::ostream & o, DiamondTrap const & rhs) {
	o << rhs.FragTrap::get_name()<< " with " << rhs.FragTrap::get_HP() << " HP and " << rhs.FragTrap::get_energy() << " energy points." << std::endl; 
	return (o);
}
